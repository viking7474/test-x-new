...
#pragma clang diagnostic pop
    ...
    if (completionHandler) {
        NSError *err = [NSError errorWithDomain:@"com.hydra.tlinkios.compat"
                                           code:14
...
- (UIImage *)weaponx_addProfileIndicator {
    ...
    NSUserDefaults *defaults = [[NSUserDefaults alloc] initWithSuiteName:@"com.hydra.tlinkios.shared"];
...
%ctor {
    ...
    PXFileDebugLoadMarker("TLinkIOSTweak.Tweak.ctor");
