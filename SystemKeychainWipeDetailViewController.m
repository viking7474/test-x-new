...
@implementation SystemKeychainWipeDetailViewController
...
- (void)viewDidLoad {
    ...
    // Warning banner
    [stack addArrangedSubview:[self buildWarningBanner]];
...
- (UIView *)buildHero {
    ...
    UIView *chip = [self iconChip:@"key" color:[UIColor systemRedColor]];
...
- (UIView *)buildWarningBanner {
    UIView *banner = [[UIView alloc] init];
    banner.translatesAutoresizingMaskIntoConstraints = NO;
    banner.backgroundColor = [[UIColor systemRedColor] colorWithAlphaComponent:0.12];
    ...
    label.text = @"Destructive action. Can sign you out of system services and is hard to undo.";
    ...
    [NSLayoutConstraint activateConstraints:@[
        [iv.leadingAnchor constraintEqualToAnchor:banner.leadingAnchor constant:14],
        [iv.topAnchor constraintEqualToAnchor:banner.topAnchor constant:14],
        [iv.widthAnchor constraintEqualToConstant:18],
        [iv.heightAnchor constraintEqualToConstant:18],
        [label.leadingAnchor constraintEqualToAnchor:iv.trailingAnchor constant:10],
        [label.trailingAnchor constraintEqualToAnchor:banner.trailingAnchor constant:-14],
